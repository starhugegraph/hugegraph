...
[![hugegraph ci](https://github.com/starhugegraph/hugegraph/actions/workflows/ci.yml/badge.svg)](https://github.com/starhugegraph/hugegraph/actions/workflows/ci.yml)
[![codecov](https://codecov.io/gh/starhugegraph/hugegraph/branch/master/graph/badge.svg?token=RX1LSG2TSV)](https://codecov.io/gh/starhugegraph/hugegraph)
...
The [project homepage](https://starhugegraph.github.io/hugegraph-doc/) contains more information on HugeGraph and provides links to documentation, getting-started guides and release downloads.
